      ...
      <body className="min-h-screen flex flex-col relative transition-colors duration-300">
        <Providers>
          ...
          <footer className="py-8 px-4 mt-12">
            <div className="max-w-7xl mx-auto liquid-glass neo-border neo-shadow-lg p-6 flex flex-col items-center bg-white/10 animate-slide-up opacity-0 [animation-fill-mode:forwards] [animation-delay:0.4s]">
              <div className="flex flex-wrap justify-center gap-4 mb-6 font-bold uppercase text-sm">
              ...
              <div className="w-full flex flex-col md:flex-row justify-between items-center border-t-2 border-black/10 dark:border-white/10 pt-6">
